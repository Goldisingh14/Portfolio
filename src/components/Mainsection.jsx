    ...
    <div  id='home' className=' w-full flex md:flex-row flex-col p-[2rem] justify-center items-center gap-8  mt-10'>
      ...
      <div className='md:w-[45%] w-full  flex flex-col gap-9'>
        <div className=' flex flex-col gap-3 justify-center items-center'>
          <h1 className='text-white sm:text-3xl text-2xl text-center font-bold font-custom leading-[2rem]'>Hii, My Name is <span className=' animated-running-border'>Goldi Singh</span> </h1>
        ...
        <div>
          <p className='text-white font-custom text-center leading-[2rem]'>
            I am learning web development and here is my portfolio website all my skill that i have  learnt till now in this field.
          </p>
        </div>
