...
{/* Detail waala section */}
        <div className='flex flex-col mt-[5rem]'>
            <button className='text-white font-custom  p-3 shadow-2xl hover:scale-[1.1] shadow-cyan-500/50 rounded-xl mb-5 namebtn'>Name :- Goldi Singh</button>
            <a href='mailto:chetanyapathak6@gmail.com' className=''>
            <button className='text-white font-custom w-full hover:scale-[1.1]  p-3 shadow-2xl shadow-cyan-500/50 rounded-xl mb-5 namebtn'>Email :- 01goldichaudhary@gmail.com</button>
            </a>
            <button className='text-white font-custom  p-3 shadow-2xl hover:scale-[1.1] shadow-cyan-500/50 rounded-xl mb-5 namebtn'>Mobile no. :- 7895035673</button>
            <button className='text-white font-custom  p-3 shadow-2xl hover:scale-[1.1] shadow-cyan-500/50 rounded-xl mb-5 namebtn'>Address :- Shivdan Nagar Iglas, District-Aligarh (U.P.)</button>
        ...
        <a href='https://drive.google.com/file/d/1Pu7leU_06_QgSWDG831RSrUbLNlKlXmh/view?usp=drivesdk'>
